...
internal class OutboundMailIntentEntity(
    ...
    @Column(name = "protected_body_ciphertext") val protectedBodyCiphertext: ByteArray?,
    @Column(name = "protected_body_nonce") val protectedBodyNonce: ByteArray?,
    @Column(name = "protected_body_key_version", length = 40) val protectedBodyKeyVersion: String?,
