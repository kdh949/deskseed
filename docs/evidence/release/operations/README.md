...
- [`2026-08-12-macos-arm64-full.md`](2026-08-12-macos-arm64-full.md) — current full V11→V15 proof. In 137s it performed anonymous pulls, no-cache backend/frontend builds, fresh V11 install, split-role and immutable-ledger denials, V11→V15 upgrade, checksumed backup, same-PostgreSQL-image fresh restore, parity/application smoke, final source-freeze checks and exact cleanup. All 25 recorded checks passed.
