...
- Measured table heap + index bytes: `44548096` (`42.48 MiB`)
- Projected default release relation bytes: `4454809600` (`4.149 GiB`)
- Transient relation/index/WAL allowance: `3x` (`12.447 GiB`)
