...
| REQ-AUT-002 | 시간 경과 기반 automation을 제공한다 | BLUEPRINT_READY | P4 | 12, 34, 45, ADR 0024 | `AutomationMigrationTest`, `AutomationDefinitionIntegrationTest`의 versioned solved-age/CLOSE_TICKET allowlist, admin capability, ETag activation history와 zero-side-effect dry-run; 후속 bounded candidate scan·idempotent claim·system transition으로 AUT-009 완료 |
