...
| REQ-CFG-014 | 고객 문의는 server-authorized form/version의 customer-safe projection과 typed candidate values를 사용하고 최종 제출에서 현재 form snapshot을 다시 검증·보존한다 | IMPLEMENTATION_READY | P0 request form | 21, 23, 25, 26, 33, 34, 39, 47, 56, ADR 0041, D-059 | `projectCustomerTicketForm`, closed customer projection/value schemas, form-aware JSON/multipart `CreateCustomerRequest`, stable existence-safe problem catalog과 documentation contract tests를 동결함. 구현은 customer/staff existence-leak, stale/current version, conditional projection, typed normalization, selected-form persistence, stable initial-command replay/conflict/single-winner, planned-customer multipart rollback, one TicketAudit를 검증; CFG-006, TKT-001/002, CHG-001/002/003, FILE-001/003/004/006, DOC-001 |
