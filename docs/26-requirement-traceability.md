...
| REQ-AI-005 | 관리자는 typed enable/stop/status/reindex 정책을 감사 가능하게 관리하고 feedback·보존·관측·평가·복구 근거를 운영한다 | IN_PROGRESS | AI V1 G/S03b | 19, 21, 23, 36, 52, ADR 0049/0053 | 서버 운영 API·retention·metadata-only 관측·합성 평가 구현; S03b는 inserted/edited interaction과 Backend-confirmed sent를 분리하고 comment/candidate dedupe·unattributed cohort·body-free edit metric을 추가; external receipt/deploy와 실제 attribution coverage는 미검증, AI-OPS-001/AI-OBS-001/AI-RET-001/AI-USE-001 |
