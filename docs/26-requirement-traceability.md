...
| REQ-AUTH-003 | 고객은 password registration과 email verification을 거쳐 로그인하고 single-use reset으로 credential과 기존 session을 안전하게 교체한다 | BLUEPRINT_READY | P0 auth | 21, 23, 25, 33, 34, 37, 39, 52, 56, ADR 0042 | identity OpenAPI freeze 후 `IMPLEMENTATION_READY`; AUTH-005/006/007, ARCH-004, MAIL-001/002, DOC-001 |
| REQ-AUTH-004 | magic-link login은 passwordless identity에만 허용하고 명시적 registration completion은 password/profile/current consent를 원자적으로 설정하되 이메일로 티켓을 claim하지 않는다 | BLUEPRINT_READY | P0 auth | 21, 23, 25, 33, 34, 37, 39, 52, 56, ADR 0029/0042 | identity OpenAPI freeze 후 `IMPLEMENTATION_READY`; AUTH-001/002/003/004/008, ARCH-004, MAIL-001/002, DOC-001 |
