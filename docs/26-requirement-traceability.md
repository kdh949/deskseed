...
| REQ-FILE-001 | private object storage 기반 첨부파일을 제공한다 | IMPLEMENTATION_READY | P1 | 38, 39, 48, 50 | 기존 PostgreSQL attachment pipeline과 production `S3AttachmentObjectStoreIntegrationTest`의 VersityGW bounded multipart exact-byte/read/delete, `AttachmentProductionBoundaryTest`의 local adapter 제외·acknowledged `UPSTREAM_WAF` source/no-rescan; Compose private object-storage network/volume 계약. Sophos 장비 rule과 object restore는 별도 운영 증거; FILE-001/003/004/006 |
