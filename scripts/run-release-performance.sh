...
performance_source_files=(
  ...
  "$repository_root/docs/performance/staff-search-two-phase-page.md"
  ...
  "$repository_root/backend/src/main/kotlin/dev/deskseed/ticketing/internal/StaffTicketSearchSqlPlan.kt"
